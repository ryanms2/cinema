...
export default function ComponentPage() {
  ...
  const formattedDateLast = format(nextMonth.setUTCDate(22), 'yyyy-MM-dd')
  ...
  const formattedDateFirst = format(startOfMonth(previousMonth), 'yyyy-MM-dd')
  ...
  const handleSearch = () => {
    if (dateCalendarFirst !== undefined || dateCalendarLast !== undefined) {
      ...
      setPrimaryDateFirst(formattedDateFirst)
      setPrimaryDateLast(formattedDateLast)
    }
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto p-4">
        <h1 className="font-extrabold text-2xl">Em breve</h1>
